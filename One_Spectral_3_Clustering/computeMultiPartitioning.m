    ...
    if(~connected)
        ...
        if(init2nd)
            ...
            if(flag) % if eigenvector computation succeeded
                ...
                [allClusters, cut,cheeger,cutPart1,cutPart2] =  createClustersGeneral(vmin,W,normalized,threshold_type,criterion_threshold,deg2,false);
        ...
        for l=1:numTrials
            ...
            start=randn(num,1);
            vmin=computeEigenvectorGeneral(W,start,normalized,verbosity>=3);
            [allClusters_temp, cut_temp,cheeger_temp,cutPart1_temp,cutPart2_temp] =  createClustersGeneral(vmin,W,normalized,threshold_type,criterion_threshold,deg2,false);
